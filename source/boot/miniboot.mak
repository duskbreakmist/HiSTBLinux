...
CONFIG_EXTERN_FLAGS := \
		...
		$(if $(CFG_HI_TEE_VMX_ULTRA_SUPPORT),CONFIG_SBL=$(CFG_HI_TEE_VMX_ULTRA_SUPPORT),)
...
SYSREG = $(SYSREGDIR)/$(BOOTCONFIG_FILE)/$(CFG_HI_BOOT_REG_NAME)
else
...
$(CONFIG_FILE): $(if $(OBJ_DIR), $(OBJ_DIR)/copy_code,) force
	...
	@$(CONFIG_EXPORT) "CONFIG_SBL=$(CFG_HI_TEE_VMX_ULTRA_SUPPORT)" \
		"Enable SBL" $@
